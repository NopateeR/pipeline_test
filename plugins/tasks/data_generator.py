...
def execute(folder_path: str):
    ...
    department_list = generate_text(number_of_item = number_of_department, long_of_text = 32, text_list = list_char)
    sensor_list = generate_text(number_of_item = number_of_sensor, long_of_text = 64, text_list = list_char)
    product_list = generate_text(number_of_item = number_of_product, long_of_text = 16, text_list = list_char)
